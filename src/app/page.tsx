...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#f6f7f2] text-slate-900">
      <header className="sticky top-0 z-40 border-b border-slate-200/70 bg-[#f6f7f2]/90 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          <div className="flex items-center gap-3">
            <Image src="/assets/logo.svg" alt={BRAND} width={180} height={48} className="h-9 w-auto" />
          </div>
          <div className="hidden items-center gap-6 text-sm text-slate-600 md:flex">
            <a href="#product" className="hover:text-emerald-700">Product</a>
      ...
      <main>
        <section className="px-6 pt-16 pb-12" id="product">
          <div className="mx-auto grid max-w-6xl items-center gap-10 md:grid-cols-[1.05fr_0.95fr]">
            <div>
              ...
              <h1 className="mt-5 text-4xl font-semibold leading-tight md:text-5xl">
                Highly purified Retatutride
              </h1>
              <p className="mt-4 text-lg text-slate-600">
                One compound, one standard. Retatutride supplied for laboratory and analytical use
                only with batch‑level documentation and controlled distribution.
              </p>
              <div className="mt-6 flex flex-wrap gap-3 text-xs">
                {[
                  ...
                  <span key={item} className="rounded-full border border-slate-200 bg-white px-3 py-1 text-slate-600">
                    {item}
                  </span>
                ))}
              </div>
        ...
        <section id="quality" className="px-6 py-14">
          <div className="mx-auto grid max-w-6xl gap-8 md:grid-cols-3">
            {[
              { title: "Expert collaboration", text: "Built with lab professionals for compliant workflows." },
              { title: "Focused catalog", text: "One compound, no clutter, consistent standards." },
              { title: "Individual support", text: "Documentation guidance and batch‑specific support." },
            ].map((item) => (
        ...
        <section className="px-6 py-14">
          <div className="mx-auto max-w-6xl rounded-3xl border border-slate-200 bg-white p-8">
          ...
          <div className="mx-auto grid max-w-6xl gap-8 md:grid-cols-[1.1fr_0.9fr]">
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <div className="flex items-center justify-between">
                ...
                <span className="rounded-full bg-emerald-100 px-3 py-1 text-xs text-emerald-700">New</span>
              </div>
      ...
      <footer className="border-t border-slate-200 bg-[#f6f7f2]">
